...
public class ViewResultActivity extends AppCompatActivity {  // Renamed to ResultActivity for clarity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewCorrectAnswersButton.setOnClickListener(v -> {
            Intent intent = new Intent(ViewResultActivity.this, CorrectActivity.class);
