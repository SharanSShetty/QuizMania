...
public class c2 extends AppCompatActivity {
    ...
    int score = 0;
    String[] questions = {
            "What is the output of the following code? int x = 5; cout << x++;",
            "What is the output of this code? int x = 5; cout << ++x;",
            ...
            "Which function is used to read a string with spaces in C++?",
            "What does the keyword 'this' represent in C++?",
    ...
    String[][] options = {
            {"5", "6", "Error", "4"},
            {"5", "6", "Error", "4"},
            {"~ClassName()", "destructor ClassName()", "~ClassName", "destroy ClassName"},
            {"public", "private", "protected", "friend"},
            {"Class obj;", "object Class;", "obj = new Class;", "new Class obj;"},
            {"::", ".", "->", "##"},
            {"continue", "stop", "break", "exit"},
            {"cin", "getline", "scanf", "getch"},
            {"Pointer to the current object", "Pointer to a variable", "Global variable", "Current object value"},
            {"Inheritance", "Encapsulation", "Polymorphism", "Compilation"}
    };

    String[] correctAnswers = {"5", "6", "~ClassName()", "private", "Class obj;", "::", "break", "getline", "Pointer to the current object", "Compilation"};
    ...
    private void setUpListeners() {
        ...
        submitButton.setOnClickListener(v -> {
            saveUserAnswer();
            calculateScore();
            Intent intent = new Intent(c2.this, c2result.class);
